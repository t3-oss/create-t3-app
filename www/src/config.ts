...
export const SIDEBAR: Sidebar = {
  ...
  ja: {
    "Create T3 App": [
      ...
      { text: "Why CT3A?", link: "ja/why" },
      { text: "Installation", link: "ja/installation" },
      { text: "Folder Structure", link: "ja/folder-structure" },
      { text: "FAQ", link: "ja/faq" },
      { text: "T3 Collection", link: "ja/t3-collection" },
      { text: "Other Recommendations", link: "ja/other-recs" },
    ],
    Usage: [
      { text: "First Steps", link: "ja/usage/first-steps" },
