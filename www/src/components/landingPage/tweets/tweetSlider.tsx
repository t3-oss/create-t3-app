    ...
    <article className="px-4 pt-4 pb-1 flex flex-wrap items-start hover:bg-white/20 bg-white/10 bg-cover rounded-lg transition-colors hover:no-underline border border-t3-purple-200/20 hover:border-t3-purple-300/50">
      ...
      <div className="w-full">
        ...
        <div className="flex items-center justify-start py-2">
          <div className="text-t3-purple-100 flex hover:text-blue-500 items-center mr-8">
            <a
              aria-label="Comment on Tweet"
              href={`https://twitter.com/intent/tweet?in_reply_to=${id}`}
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full flex items-center justify-center hover:text-blue-500"
            >
          ...
          <div className="text-t3-purple-100 flex hover:text-green-500 items-center mr-8">
            <a
              aria-label="Retweet"
              href={`https://twitter.com/intent/retweet?tweet_id=${id}`}
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full flex items-center justify-center hover:text-green-500"
            >
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
                <g>
          ...
          <div className="text-t3-purple-100 flex hover:text-red-500 items-center mr-6">
            <a
              aria-label="Like"
              href={`https://twitter.com/intent/like?tweet_id=${id}`}
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full flex items-center justify-center hover:text-red-500"
            >
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
                <g>
