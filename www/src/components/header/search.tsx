  ...
  return (
    <>
      <button
        ...
        ref={searchButtonRef}
        onClick={onOpen}
        className="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-gray-700 dark:bg-white bg-slate-900 shadow-md shadow-slate-500 dark:shadow-slate-500/10 rounded-lg ring-slate-900"
      >
