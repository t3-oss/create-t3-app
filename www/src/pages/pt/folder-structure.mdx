...
1. Definimos o contexto usado nas solicitações tRPC. Veja [uso do tRPC](usage/trpc#-serverapitrpcts) para mais informações.
2. Exportamos os auxiliares de procedimento. Veja [uso do tRPC](usage/trpc#-serverapitrpcts) para mais informações.
