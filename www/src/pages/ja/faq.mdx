...
しかし、実装に苦労があって参考プロジェクトを見たい場合は、[next-i18next](https://github.com/i18next/next-i18next)を使って T3 アプリに i18n を追加する方法を紹介する[参考リポジトリ](https://github.com/juliusmarminge/t3-i18n)を用意しています。
...
[T3-公理#2](/ja/introduction#問題を解決する)の通り、我々は最先端のものを愛しているが、安定性を重視しており、ルーター全体を移植するのは難しく、[bleed するには良い場所ではない](https://youtu.be/mnwUbtieOuI?t=1662)とされています。API はベータ版であり、変更されることが予想されます。
