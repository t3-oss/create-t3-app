...
<blockquote className="w-full relative border-l-4 italic bg-t3-purple-100 dark:text-t3-purple-50 text-zinc-900 dark:bg-t3-purple-400/10 p-2 rounded-md text-sm my-3 border-neutral-500 quote shadow-lg">
