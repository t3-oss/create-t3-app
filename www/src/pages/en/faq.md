...
Although the resources listed below are some of the best that exist for the T3 Stack, the community (and [Theo](https://youtu.be/rzwaaWH0ksk?t=1436)) recommend that you just start using the stack by yourself and learn along the way by building with it. If you're looking for a solution like `create-t3-app`, chances are you might've already used some of the parts of the stack. So why not just dive headfirst and learn the other parts while you build something?!
